...
def main(base_url, to_search):
    ...
    while to_check and max_checks:
        link = to_check.pop(0)
        links = proccess_link(link, text=to_search)
...
if __name__ == '__main__':
    ...
    parser.add_argument(dest='url', type=str, help='Base url site. '
                        'Use "http://localhost:8000/" '
                        'for the recipe example'
                        )
    parser.add_argument('-p', type=str, help=f'Sentence to search, default: {DEFAULT_PHRASE}',
